...
de l'\citeauthor{samm_v2.0_owasp_project_2021}. Cette méthodologie mit à jours en \citedate{samm_v2.0_owasp_project_2021}
...
sécurisation de code et au développement sécurisé dans son rapport \citetitle{six_pillarss_devsecops_safecode_2020} de 
...
Ainsi, il est possible d'étendre l'usage des outils de test automatique en ajoutant en intégrant de nouveaux jeux de 
...
Le second aspect de sécurité opérationnel porte quant à lui sur la gestion de la sécurité de ses environnements, de 
production ou non.
